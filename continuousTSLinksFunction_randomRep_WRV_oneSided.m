...
function[] = continuousTSLinksFunction_randomRep_WRV_oneSided(dataSetList, s, n, ...
                                                 r, rs)
...
% get the expressed genes from the matrix. 
    ...
    toc
    fileName = sprintf('~/networks/continuousTSLinksResults/%d_oneSided_random%d_%d_%d_pVals.mat', ...
                        rs, s, n, r)
    save(fileName, 'pVals');
end
